...
MATHLIB_INSTALL_DIR?=$(DEPOT_DSP)/mathlib_c674x_3_1_0_0
...
XDCPATH?=$(CE_INSTALL_DIR)/packages;$(XDAIS_INSTALL_DIR)/packages;$(DSPLIB_INSTALL_DIR)/packages;$(IMGLIB_INSTALL_DIR)/packages;$(MATHLIB_INSTALL_DIR)/packages
